...
},
{
    ...
    "Inventory Sync Request", "Wardrobe Resync Request", "Door Interact ", "Sorry Mate, Wrong Path :/", "Melee Combo Reset", "Update Character State", "Character Humanoid Update", "Character Root Update", "Get Player Stance Speed", "Zombie State Resync Attempt", "Sync Near Chunk Loot"
},
{
    [110] = "Contractor",
    [120] = "Moderator",
