...
},
{
    ...
    "Inventory Sync Request", "Wardrobe Resync Request", "Door Interact ", "Sorry Mate, Wrong Path :/", "Melee Combo Reset", "Character Humanoid Update", "Character Root Update", "Get Player Stance Speed"
},
{
    [110] = "Contractor",
    [120] = "Moderator",
